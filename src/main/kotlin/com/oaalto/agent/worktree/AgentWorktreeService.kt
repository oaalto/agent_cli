...
class AgentWorktreeService(
    ...
    fun deleteWorktree(worktreePath: String): Result<Unit> {
        ...
        val tree =
            existingTrees.firstOrNull { normalizePathKey(it.hostPath) == normalizePathKey(worktreePath) }
                ?: run {
    ...
    private fun generateWorktreePath(
    ...
    private fun slug(rawValue: String): String {
        ...
        val slug =
            normalized
                .replace(SLUG_INVALID_CHARACTERS, "-")
    ...
    private fun mapHostPathToGitPath(
        hostPath: String,
        repositoryRootPath: String,
    ): String =
    ...
    private fun normalizePathKey(path: String): String = AgentWorktreePathMapper.normalizePathKey(path)

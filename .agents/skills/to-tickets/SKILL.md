---
name: to-tickets
description: Break a plan, spec, or conversation into tracer-bullet tickets under docs/features/<feature_name>/, each declaring blocking edges — one numbered file per ticket co-located with the PRD.
...
When the source is a PRD, read `docs/features/<feature_name>/prd.md`.

---
name: to-spec
description: Turn the current conversation into a spec and save it to docs/features/<feature_name>/prd.md — no interview, just synthesis of what you've already discussed.
